...
const TRANSITION_DEF = {
  ...
  'shred-rect-out': { tag: 'p14:shred',    attrs: { pattern: 'rectangle', dir: 'out' }, spd: 'slow', ns: ['p14'] },

  // ── P14 "prism" inverted variants ─────────────────────────────────────────
  'prism-inverted':   { tag: 'p14:prism',  attrs: { isInverted: '1' },         spd: 'slow', ns: ['p14'] },
  'prism-inverted-r': { tag: 'p14:prism',  attrs: { dir: 'r', isInverted: '1' }, spd: 'slow', ns: ['p14'] },
  'prism-inverted-u': { tag: 'p14:prism',  attrs: { dir: 'u', isInverted: '1' }, spd: 'slow', ns: ['p14'] },
  'prism-inverted-d': { tag: 'p14:prism',  attrs: { dir: 'd', isInverted: '1' }, spd: 'slow', ns: ['p14'] },
  ...
  'wind-right':      { tag: 'p15:prstTrans', attrs: { prst: 'wind', invX: '1' },    spd: 'slow', ns: ['p14', 'p15'] },
  'airplane-left':   { tag: 'p15:prstTrans', attrs: { prst: 'airplane' },           spd: 'slow', ns: ['p14', 'p15'] },
  'airplane-right':  { tag: 'p15:prstTrans', attrs: { prst: 'airplane', invX: '1' }, spd: 'slow', ns: ['p14', 'p15'] },
  'origami-left':    { tag: 'p15:prstTrans', attrs: { prst: 'origami' },            spd: 'slow', ns: ['p14', 'p15'] },
  'origami-right':   { tag: 'p15:prstTrans', attrs: { prst: 'origami', invX: '1' }, spd: 'slow', ns: ['p14', 'p15'] },
  'fallover-left':   { tag: 'p15:prstTrans', attrs: { prst: 'fallOver' },           spd: 'slow', ns: ['p14', 'p15'] },
  'fallover-right':  { tag: 'p15:prstTrans', attrs: { prst: 'fallOver', invX: '1' }, spd: 'slow', ns: ['p14', 'p15'] },
  'drape-left':      { tag: 'p15:prstTrans', attrs: { prst: 'drape' },              spd: 'slow', ns: ['p14', 'p15'] },
  'drape-right':     { tag: 'p15:prstTrans', attrs: { prst: 'drape', invX: '1' },   spd: 'slow', ns: ['p14', 'p15'] },
  ...
  'pagecurldouble':  { tag: 'p15:prstTrans', attrs: { prst: 'pageCurlDouble' },     spd: 'slow', ns: ['p14', 'p15'] },
  'pagecurldouble-r':{ tag: 'p15:prstTrans', attrs: { prst: 'pageCurlDouble', invX: '1' }, spd: 'slow', ns: ['p14', 'p15'] },
  'pagecurlsingle':  { tag: 'p15:prstTrans', attrs: { prst: 'pageCurlSingle' },    spd: 'slow', ns: ['p14', 'p15'] },
  'pagecurlsingle-r':{ tag: 'p15:prstTrans', attrs: { prst: 'pageCurlSingle', invX: '1' }, spd: 'slow', ns: ['p14', 'p15'] },
...
export function getTransitionXml(transitionData) {
  ...
  const nsDecls = requiredNs
    .map(prefix => `xmlns:${prefix}="${NS[prefix]}"`)
    .join(' ');
